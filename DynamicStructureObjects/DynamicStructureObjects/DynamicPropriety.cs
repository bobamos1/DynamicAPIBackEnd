...
namespace DynamicStructureObjects
{
    public class DynamicPropriety
    {
        ...
        internal static readonly Query getRoles = Query.fromQueryString(QueryTypes.CBO, "SELECT id, canModify FROM PermissionProprieties INNER JOIN Roles ON id = id_role WHERE id_propriety = @ProprietyID", true);
        ...
        internal static readonly Query insertPropriety = Query.fromQueryString(QueryTypes.INSERT, "INSERT INTO Proprieties (name, isMain, isUpdatable, id_ShowType, id_controller) VALUES (@Name, @IsMain, @IsUpdatable, @ShowTypeID, @ControllerID)", true);
