...
namespace DynamicStructureObjects
{
    public class DynamicFilter
    {
        ...
        public DynamicFilter(long id, string DisplayName, string Description, long ShowTypeID, int ind, string placeholder)
        {
            this.id = id;
            this.ind = ind;
        ...
        { }
        public DynamicFilter(string DisplayName, string Description, string placeholder, ShowTypes ShowType, int ind, IEnumerable<DynamicSQLParamInfo> AffectedVars)
        {
            this.ind = ind;
            this.Name = DisplayName;
            this.Description = Description;
        ...
        {
            return addFilter(DisplayName, Description, placeholder, showType, ind, RouteID, (IEnumerable<DynamicSQLParamInfo>)SQLVariables);
        }
        public async static Task<DynamicFilter> addFilter(string DisplayName, string Description, string placeholder, ShowTypes showType, int ind, long RouteID, IEnumerable<DynamicSQLParamInfo> SQLVariables)
        {
